...
for chi_w in args.chi_w:
    tag = f"L{args.L}_T{args.trial_chi}_w{chi_w}_s{args.seed}" if args.U == 4.0 else \
        f"L{args.L}_U{args.U:g}_T{args.trial_chi}_w{chi_w}_s{args.seed}"
    cfg = (f"L={args.L}, n_up={args.L // 2}, n_down={args.L // 2}, interaction={args.U}, trial_chi={args.trial_chi}, "
           f"walker_channel_chi={chi_w}, n_walkers={args.walkers}, n_equilibration={args.eql}, "
